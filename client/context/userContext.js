...
///// new 
  ...
  return (
    <UserContext.Provider value={{ registerUser , userState , handlerUserInput , loginUser, logOutUser ,  userLoggedInStatus , user , updateUser ,  emailVerification , loading, router , verifyUser , forgotpasswordEmail , resetPassword , changePassword, allUsers, deleteUser, }}>
      {children}
